...
namespace ReadModel.Features.Stats
{
    ...
    {
        public IEnumerable<ExpertStatsReadDto> DenormalizePredictionResultsToDto(IReadOnlyDictionary<Expert, PredictionsResultAccumulator> predictionResultsByExpert, ICommonPredictionPointSystem commonPredictionPointSystem)
        {
