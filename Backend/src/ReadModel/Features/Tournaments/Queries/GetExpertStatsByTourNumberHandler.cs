...
{
    public class GetExpertStatsByTourNumberHandler: IRequestHandler<GetExpertStatsByTourNumber, IEnumerable<ExpertStatsReadDto>>
    {
        private readonly PredictionsContext _context;
        private readonly PredictionService _predictionService;
        private readonly StatService _statService;

        public GetExpertStatsByTourNumberHandler(PredictionsContext context)
        {
            _context = context;
